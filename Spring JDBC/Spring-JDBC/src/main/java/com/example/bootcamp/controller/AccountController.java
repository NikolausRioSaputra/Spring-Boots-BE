...
import com.example.bootcamp.model.Amount;
...
public class AccountController {
    ...
    @GetMapping("/join1")
    public HttpEntity<List<AccountInfo>> listAllJoin(){
        return new ResponseEntity<>(service.listAccountJoin(), HttpStatus.OK);
    }

    @GetMapping("/joinBank1")
    public HttpEntity<List<bankInfo>> listAllBankJoin(){
        return new ResponseEntity<>(service.listBankJoin(), HttpStatus.OK);
    }
